...
- [BigDecimal 解决浮点数运算精度丢失问题](docs/java/basis/bigdecimal.md)
...
6. [CompletableFuture 入门](docs/java/concurrent/completablefuture-intro.md)
...
1.  **Java 8** ：[Java 8 新特性总结（翻译）](docs/java/new-features/java8-tutorial-translate.md)、[Java8 常用新特性总结](./docs/java/new-features/java8-common-new-features.md)
...
1. [谢希仁老师的《计算机网络》内容总结](docs/cs-basics/network/谢希仁老师的《计算机网络》内容总结.md)
...
4. [树](docs/cs-basics/data-structure/tree.md) ：重点关注[红黑树](docs/cs-basics/data-structure/red-black-tree.md)、B-，B+，B\*树、LSM 树
...
2. **[MySQL 知识点总结](docs/database/mysql/mysql-questions-01.md)** (必看 :+1:)
3. [一千行 MySQL 学习笔记](docs/database/mysql/a-thousand-lines-of-mysql-study-notes.md)
4. [MySQL 高性能优化规范建议](docs/database/mysql/mysql-high-performance-optimization-specification-recommendations.md)
5. [MySQL 入门](.docs/help/MySQL.md)

**重要知识点：**

1. [MySQL 数据库索引总结](docs/database/mysql/mysql-index.md)
2. [事务隔离级别(图文详解)](docs/database/mysql/transaction-isolation-level.md)
3. [MySQL 三大日志(binlog、redo log 和 undo log)详解](docs/database/mysql/mysql-logs.md)
4. [InnoDB 存储引擎对 MVCC 的实现](docs/database/mysql/innodb-implementation-of-mvcc.md)
5. [一条 SQL 语句在 MySQL 中如何被执行的?](docs/database/mysql/how-sql-executed-in-mysql.md)
6. [字符集详解：为什么不建议在 MySQL 中使用 utf8 ？](docs/database/character-set.md)
...
2. [3 种常用的缓存读写策略](docs/database/redis/3-commonly-used-cache-read-and-write-strategies.md)
3. [Redis 内存碎片](./docs/database/redis/redis-memory-fragmentation.md)
...
- [Docker 从入门到上手干事](./docs/tools/docker/docker-in-action.md)
...
最近有朋友问到定时任务相关的问题。于是，我简单写了一篇文章总结一下定时任务的一些概念以及一些常见的定时任务技术选型：[《Java 定时任务大揭秘》](./docs/system-design/schedule-task.md)
...
- [开源项目](./docs/open-source-project/tutorial.md)

## 开发工具

1. ### Git

- [Git 简介](./docs/help/git.md)
- [Git 入门](./docs/tools/git/git-intro.md)
